...
<div class="container">
    <div class="bungkus" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); width:30%;">
            ...
            <div class="judul text-center" style="margin-top:200px">
                ...
                <h3 style="color:#0275d8; letter-spacing:2px;"> Tambah Data Menu's</h3>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="name" class="form-control" name="judul" id="name" placeholder="NasiGoreng">
                        <label for="name">Judul</label>
                     </div>

                     <div class="form-floating mb-3">
                        <textarea class="form-control" name="body" placeholder="Deskripsion" id="floatingTextarea"></textarea>
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="harga" id="price" placeholder="15.000">
